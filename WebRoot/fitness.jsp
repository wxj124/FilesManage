...
<html>
  ...
  <body class=html id="homefirst">
	...
	<h1> files manage </h1>
	 ...
	 <div id="menu">
		...
		<ul>
			...
			<li class="currentLink"><a href="./fitness.jsp" title="天津河西疗养院-健身房">健身房_6</a></li>
		</ul>
		<h2>服务中心</h2>	
		<ul>
   ...
   <form action="facility_select" method="post">
	...
	<tr>
	<td>属于健身房设备请填6<input type="text" name="num" style="width: 185px; "></td></tr>
	<tr>
