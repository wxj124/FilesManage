...
<html>
  ...
  <body class=html id="homefirst">
   ...
   <div id="header">
	...
	<div id="content">
	 <br> <form action="person_add" method="post">
    <table width="40%" border="1" cellpadding="0" cellspacing="0" align="center" style="height:100px; width: 270px; ">
	<tr>
	<td><h3>人员增加:</h3></td></tr>
	<tr>
	<td>名字<input name="name"  type="text"></td></tr>
	<tr>
	<td>所在场地编号<input name="mark" type="text"></td>
	</tr>
	<tr>
	<td><input type="submit" value="增加"></td></tr>
	...
	<div id="right">
		...
		<ul>
			...
			<li class="currentLink"><a href="./person_add.jsp" title="天津河西疗养院">增加人员</a></li>
