...
<html>
  ...
  <body class=html id="homefirst">
	...
	<h1> files manage </h1>
	 ...
	 <div id="menu">
		...
		<ul>
			...
			<li class="currentLink"><a href="./health.jsp" title="天津河西疗养院-保健室">保健室_9</a></li>
		</ul>
	</div> 
   ...
   <form action="facility_select" method="post">
	...
	<tr>
	<td>属于保健室设备请填9<input type="text" name="num" style="width: 185px; "></td></tr>
	<tr>
