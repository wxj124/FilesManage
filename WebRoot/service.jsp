  ...
  <body class=html id="homefirst">
	...
	<h1> files manage </h1>
	 ...
	 <div id="menu">
		...
		<h2>服务中心</h2>	
		<ul>
			<li class="currentLink"><a href="./service.jsp" title="天津河西疗养院-综合服务处">综合服务处_7</a></li>
   ...
   <form action="facility_select" method="post">
	...
	<tr>
	<td>属于服务处设备请填7<input type="text" name="num" style="width: 185px; "></td></tr>
	<tr>
