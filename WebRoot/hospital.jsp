  ...
  <body class=html id="homefirst">
	...
	<h1> files manage </h1>
	 ...
	 <div id="menu">
		<h2>医疗卫生</h2>
		<ul>
			<li class="currentLink"><a href="./hospital.jsp" title="天津河西疗养院-医院">医院_1</a></li>
   ...
   <form action="facility_select" method="post">
	...
	<tr>
	<td>属于医院设备请填1<input type="text" name="num" style="width: 185px; "></td></tr>
	<tr>
