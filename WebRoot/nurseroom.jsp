...
<html>
  ...
  <body class=html id="homefirst">
	...
	<h1> files manage </h1>
	 ...
	 <div id="menu">
		...
		<ul>
			...
			<li class="currentLink"><a href="./nurseroom.jsp" title="天津河西疗养院-护理室">护理室_3</a></li>
			</ul>
		<h2>文化体育</h2>	
		<ul>
   ...
   <form action="facility_select" method="post">
	...
	<tr>
	<td>属于护理室设备请填3<input type="text" name="num" style="width: 185px; "></td></tr>
	<tr>
